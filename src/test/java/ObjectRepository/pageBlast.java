...
public class pageBlast {
    ...
    String dataBlast = "src/test/resources/File/blastName.txt";
    ...
    //    public By getBtnMemberone() {
//        By btnMemberone = By.xpath("//android.widget.ImageView[@content-desc='Faldi Silaen']");
//        return btnMemberone;
//    }
    public By getBtn_at() {
        return btn_at;
